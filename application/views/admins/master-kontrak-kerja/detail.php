<div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title"><?php echo $mkk['no_kontrak']; ?></h4>
                    </div>
                </div>
                        ...
                        <div class="card-box task-detail">
                            ...
                            <div class="media m-b-20">
                                <div class="media-left">
                                    <a href="#"> <img class="media-object img-circle" alt="64x64" src="<?php echo base_url('./upload/image/thumbs/'.$mkk['image']) ?>" style="width: 48px; height: 48px;"> </a>
                                </div>
                                <div class="media-body">

                                    <h4 class="media-heading m-b-0"><?php echo $mkk['nama_client']; ?></h4>
                                    <span class="label label-info"><?php echo $mkk['stts_kontrak']; ?></span>
                                </div>
                            </div>

                            <h4 class="font-600 m-b-20"><?php echo $mkk['no_pa']; ?></h4>
                            ...
                            <ul class="list-inline task-dates m-b-0 m-t-20">
                                <li>
                                    ...
                                    <p> <?php echo date('M/d/Y', strtotime($mkk['start'])); ?></p>
                                </li>

                                <li>
                                    <h5 class="font-600 m-b-5">Due Date</h5>
                                    <p> <?php echo date('M/d/Y', strtotime($mkk['due'])); ?></p>
                                </li>
                            </ul>
