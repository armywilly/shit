                ...
                <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                        <ul class="nav nav-tabs" data-tabs="tabs">
                            <li>
                                <a href="<?php echo base_url('admin/associates/create') ?>" class="btn btn-primary">
                                    <i class="material-icons">add_circle_outline</i> Add Associates
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="td-actions">
                                ...
                                <a type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-simple btn-xs" href="<?php echo base_url('admin/associates/edit/'.$list->id_staff) ?>">
                                            <i class="material-icons">edit</i>
                                </a>
                                <a type="button" rel="tooltip" title="Delete Task" class="btn btn-danger btn-simple btn-xs" href="<?php echo base_url('admin/associates/delete/'.$list->id_staff) ?>">
