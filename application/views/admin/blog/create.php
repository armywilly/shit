                        ...
                        <div class="col-md-12 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form action="<?php echo base_url('admin/blog/create') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" name="keywords" class="form-control" value="<?php echo set_value('keywords') ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <textarea type="text" name="content" class="form-control" id="#"><?php echo set_value('content') ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
