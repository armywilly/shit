                        ...
                        <div class="col-md-12 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form action="<?php echo base_url('sim/data_task_lawyer/create') ?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-6">
                                        ...
                                        <a href="<?php echo base_url('sim/data_task_lawyer') ?>" type="button" name="cancel" class="btn btn-danger">Cancel</a>
