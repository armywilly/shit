<!-- Footer -->
        ...
        <![endif]-->
        <script src="<?php echo base_url() ?>assets/sim/assets/plugins/jquery-knob/jquery.knob.js"></script>

        <!--Morris Chart-->
        <script src="<?php echo base_url() ?>assets/sim/assets/plugins/morris/morris.min.js"></script>
        <script src="<?php echo base_url() ?>assets/sim/assets/plugins/raphael/raphael-min.js"></script>

        <!-- Dashboard init -->
        <script src="<?php echo base_url() ?>assets/sim/assets/pages/jquery.dashboard.js"></script>

        <!-- file uploads js -->
        <script src="<?php echo base_url() ?>assets/sim/assets/plugins/fileuploads/js/dropify.min.js"></script>
