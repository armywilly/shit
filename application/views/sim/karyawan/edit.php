                              ...
                              <form action="<?php echo base_url('sim/karyawan/edit/'.$k['id_staff']) ?>" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="date" id="datepicker-autoclose" name="tgl_lahir" class="form-control" value="<?php echo $k['tgl_lahir'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="id_jabatan" class="form-control">
                                                        ...
                                                        <option value="<?php echo $list['id_jabatan']; ?>" <?php if($list['id_jabatan']==$list['id_jabatan']) { echo "selected"; } ?>><?php echo $list['jabatan']; ?></option>
                                                        <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                            ...
                                            <textarea id="elm1" name="biodata" rows="7" class="form-control"><?php echo $k['biodata'] ?></textarea>
                                    </div>
                                </div>
